...
export default {
	srcDir: __dirname,
	buildDir: 'apps/api.upforweb.com/.nuxt/api.upforweb.com',
	generate: {
	  dir: 'apps/api.upforweb.com/generate',
	},
	server: {
		port: 4040, // default: 3000 for localhost | for production server default is 8080 // has to be the same as the port that is using in custom.conf
