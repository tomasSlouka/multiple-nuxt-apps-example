<template>
    <div class='component grid col-2'>
        <div class='grid box newsletter align-content-start'>
            ...
            <div class='body grid gap-20 auto align-items-start justify-items-start justify-content-start'>
                ...
                <div class='grid gap-10'>
                    ...
                    <button v-if='$store.state.auth.userData.user_subscriptions.includes(newsletterData.id)' class="cta red" @click='unsubscribe()'>Unsubscribe</button>
...
export default {
    ...
    methods: {
        async subscribe() {
            await this.$axios.$put('/user/subscribe', {
        ...
        async unsubscribe() {
            await this.$axios.$put('/user/unsubscribe', {
                "newsletter_id": this.newsletterData.id,
            })
            .then((response) => {
                console.log(response)
