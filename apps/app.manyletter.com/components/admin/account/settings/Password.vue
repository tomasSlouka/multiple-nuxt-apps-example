        ...
        <div class="box grid gap-20">
            ...
            <form @submit.prevent='submitForm' class='grid gap-60 md-col-2 align-items-start'>
                ...
                <div class='grid gap-20'>
                    ...
                    <div class="hr"></div>
                    <div class='grid col-2 gap-10 auto justify-items-start justify-content-start align-items-center'>
                        ...
                        <p class='info small' v-show='submitSuccess'> {{ submitText }} </p>
                        <p class='error small' v-show='submitError'> {{ submitText }} </p>
                    </div>
                </div>
            </form> 
        </div>
