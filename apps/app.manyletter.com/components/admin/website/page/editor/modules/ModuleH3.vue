<template>
    <div class='module'>
        <textarea ref='handleHeight' class='text' rows='1' data-min-rows='1' placeholder='H3: Start typing here' @focus='handleHeight' @input='handleHeight' v-model='contentData'></textarea>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        handleHeight: function() {
            ...
            rows = Math.ceil((el.scrollHeight - el.baseScrollHeight) / 33);
