<template>
    <div class='module'>
        <textarea ref='handleHeight' class='text' rows='1' data-min-rows='1' placeholder='H4: Start typing here' @focus='handleHeight' @input='handleHeight' v-model='contentData'></textarea>
    </div>
</template>
