...
export default {
	srcDir: __dirname,
	buildDir: 'apps/makerprofile.com/.nuxt/makerprofile.com',
	generate: {
	  dir: 'apps/makerprofile.com/generate',
	},
	server: {
		port: 8000, // default: 3000 for localhost | for production server default is 8080 // has to be the same as the port that is using in custom.conf
