...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./apps/tulaveknizky.sk/components/admin/titles/FormAdd.vue?vue&type=template&id=4fdcfc5e&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"component"},[_vm._ssrNode("<div class=\"container-standard grid\" data-v-4fdcfc5e>","</div>",[_vm._ssrNode("<div class=\"grid gap-40\" data-v-4fdcfc5e>","</div>",[_vm._ssrNode("<h2 data-v-4fdcfc5e>Nový knižný titul</h2> "),_vm._ssrNode("<div class=\"box-form\" data-v-4fdcfc5e>","</div>",[_vm._ssrNode("<form class=\"grid gap-30 md-col-2 align-items-start\" data-v-4fdcfc5e>","</form>",[_vm._ssrNode("<div class=\"grid gap-20\" data-v-4fdcfc5e><div data-v-4fdcfc5e><label for=\"name\" data-v-4fdcfc5e>Názov knihy</label> <input type=\"text\" placeholder=\"Názov knihy\" name=\"name\""+(_vm._ssrAttr("value",(_vm.name)))+" data-v-4fdcfc5e></div> <div data-v-4fdcfc5e><label for=\"author\" data-v-4fdcfc5e>Autor</label> <input type=\"text\" placeholder=\"Autor\" name=\"author\""+(_vm._ssrAttr("value",(_vm.author)))+" data-v-4fdcfc5e></div> <div data-v-4fdcfc5e><label for=\"price\" data-v-4fdcfc5e>Cena</label> <input type=\"text\" placeholder=\"Cena\" name=\"price\""+(_vm._ssrAttr("value",(_vm.price)))+" data-v-4fdcfc5e></div></div> <div class=\"grid gap-20\" data-v-4fdcfc5e><div data-v-4fdcfc5e><label for=\"short_text\" data-v-4fdcfc5e>Krátky popis</label> <textarea type=\"text\" placeholder=\"Krátky popis\" name=\"short_text\" data-v-4fdcfc5e>"+_vm._ssrEscape(_vm._s(_vm.short_text))+"</textarea></div> <div data-v-4fdcfc5e><label for=\"long_text\" data-v-4fdcfc5e>Celý popis</label> <textarea type=\"text\" placeholder=\"Celý popis\" name=\"long_text\" class=\"long\" data-v-4fdcfc5e>"+_vm._ssrEscape(_vm._s(_vm.long_text))+"</textarea></div></div> <div class=\"md-span-2 hr\" data-v-4fdcfc5e></div> "),_vm._ssrNode("<div class=\"justify-self-end md-span-2 grid col-3 auto gap-10 align-items-center\" data-v-4fdcfc5e>","</div>",[_vm._ssrNode("<div data-v-4fdcfc5e>"+((_vm.submitSuccess)?("<p class=\"success\" data-v-4fdcfc5e>"+_vm._ssrEscape(_vm._s(_vm.submitText))+"</p>"):"<!---->")+"</div> "),_c('nuxt-link',{staticClass:"button cta red",attrs:{"to":"/admin/titles"}},[_vm._v("Zrušiť")]),_vm._ssrNode(" <button type=\"submit\" class=\"button cta black\" data-v-4fdcfc5e>Uložiť</button>")],2)],2)])],2)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./apps/tulaveknizky.sk/components/admin/titles/FormAdd.vue?vue&type=template&id=4fdcfc5e&scoped=true&
  ...
  methods: {
    async submitForm() {
      ...
      await this.$axios.$post('/book', {
        ...
        setTimeout(() => this.submitSuccess = false, 4000); // this.$router.push('/admin/titles/detail/'+ response.id)
...
/* harmony default export */ var FormAdd = __webpack_exports__["a"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./apps/tulaveknizky.sk/pages/admin/storage/add/index.vue?vue&type=template&id=409653c2&
...
// CONCATENATED MODULE: ./apps/tulaveknizky.sk/pages/admin/storage/add/index.vue?vue&type=template&id=409653c2&
...
// EXTERNAL MODULE: ./apps/tulaveknizky.sk/components/admin/titles/FormAdd.vue + 4 modules
var FormAdd = __webpack_require__(109);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./apps/tulaveknizky.sk/pages/admin/storage/add/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  ...
  components: {
    ...
    Hero: Hero["a" /* default */],
    FormAdd: FormAdd["a" /* default */]
  }
});
// CONCATENATED MODULE: ./apps/tulaveknizky.sk/pages/admin/storage/add/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var storage_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./apps/tulaveknizky.sk/pages/admin/storage/add/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  storage_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
