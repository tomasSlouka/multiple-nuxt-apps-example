...
export default {
  srcDir: __dirname,
  buildDir: 'apps/app.howtonewsletter.com/.nuxt/app.howtonewsletter.com',
  generate: {
    dir: 'apps/app.howtonewsletter.com/generate',
  },
  server: {
      port: 6666, // default: 3000 for localhost | for production server default is 8080 // has to be the same as the port that is using in custom.conf
 ...
 head: {
    ...
    meta: [
        ...
        { hid: 'og-url', property: "og:url", content: "https://app.howtonewsletter.com/" },
        ...
        { hid: 'og-image', property: "og:image", content: "https://app.howtonewsletter.com/_static/howtonewsletter/cover-twitter.png" },
        { hid: 'og-image:type', property: 'og:image:type', content: 'image/png' },
        { hid: 'og-image:width', property: 'og:image:width', content: '1200' },
        { hid: 'og-image:height', property: 'og:image:height', content: '628' },
        { hid: 'twitter-card', property: "twitter:card", content: "summary_large_image" },
        { hid: 'twitter-url', property: "twitter:url", content: "https://app.howtonewsletter.com/" },
        ...
        { hid: 'twitter-image', property: "twitter:image", content: "https://app.howtonewsletter.com/_static/howtonewsletter/cover-twitter.png" },
