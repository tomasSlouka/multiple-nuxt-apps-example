        ...
        <div class="container-narrow mt80">
            <div class='grid md-col-2 gap-80 align-content-center align-items-center'>
                <div class='grid gap-20'>
                    <h1 class='maxw500'>Browse all domains up for sale.</h1>
        ...
        <div class="container-narrow mt80">
            <div class='grid gap-20'>
                ...
                <div class='grid md-col-3 gap-20 align-items-start justify-content-start'>
                    <nuxt-link tag='div' v-for='item in domainList.data' :key='item.id' :to='"/domain/detail/" + item.name' class="box-domain grid gap-10"> 
                        <h4> {{item.name}}</h4>
