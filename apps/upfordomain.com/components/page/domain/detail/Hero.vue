        ...
        <div class="container-narrow mt80">
            <div class='grid md-col-2 gap-80'>
                ...
                <div class='box grid gap-20 align-content-start align-self-end justify-self-center'>
                    <h3 class=''>Make offer</h3>
                    <!-- <p class='note'>Do you like the domain, but the price is too high (or low)? Start the negotiation. 🧐</p> -->
                    <form @submit.prevent @submit='submitForm()'>
                        <div class="grid gap-20">
                            ...
                            <button type='submit' class='cta justify-self-start align-self-start'>Send offer</button>
                            <p class='small'>Offers sent are non-binding.</p>
                        </div>
                    </form>
                </div>
