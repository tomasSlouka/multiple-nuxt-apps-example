        ...
        <div class="container-narrow mt80">
            <div class='grid md-col-2 gap-80'>
                <div class='grid gap-20 align-content-start align-items-start'>
                    <h1 class='maxw500'>Create your personal portfolio of domain names up for sale. </h1>
                    <!-- <h2>Receive offers from buyers.</h2> -->
                    <!-- <h1 class='maxw500'>Why sell your domain when you can rent it?</h1> -->
                    <p class='maxw500'>Do you own a domain that costs you money and is doing nothing? List your domain up for sale, and receive offers from domain brokers or business owners who search for new domains.</p>
                    
                    <div class='grid col-1 gap-30'>
                        <div class='testimonial grid gap-20 justify-self-start mt40'>
                            <p class='small'><span class='font20'>🔥</span> Upfordomain service has not launched yet, but there are already <nuxt-link to='/domains/browse' tag='span' class='pointer strong underline'>{{domainStats.count}} domains ready for you</nuxt-link>.</p>
                ...
                <div class='box grid gap-20 align-content-start align-self-end justify-self-center'>
                    ...
                    <form @submit.prevent @submit='submitForm()'>
                        <div class="grid gap-20">
                            ...
                            <button type='submit' class='cta justify-self-start align-self-start'>Add my domain</button>
