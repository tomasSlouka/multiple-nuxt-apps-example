...
import nuxt_plugin_vuescrollto_55787f84 from 'nuxt_plugin_vuescrollto_55787f84' // Source: .\\vue-scrollto.js (mode: 'client')
import nuxt_plugin_cookieuniversalnuxt_d702ddda from 'nuxt_plugin_cookieuniversalnuxt_d702ddda' // Source: .\\cookie-universal-nuxt.js (mode: 'all')
import nuxt_plugin_axios_4db3276b from 'nuxt_plugin_axios_4db3276b' // Source: .\\axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (process.client && typeof nuxt_plugin_vuescrollto_55787f84 === 'function') {
    await nuxt_plugin_vuescrollto_55787f84(app.context, inject)
  }

  if (typeof nuxt_plugin_cookieuniversalnuxt_d702ddda === 'function') {
    await nuxt_plugin_cookieuniversalnuxt_d702ddda(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_4db3276b === 'function') {
    await nuxt_plugin_axios_4db3276b(app.context, inject)
  }
