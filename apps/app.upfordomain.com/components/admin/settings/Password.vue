    ...
    <div class='component grid gap-20'>
        <div class="box grid gap-20">
            ...
            <form @submit.prevent='submitForm' class='grid gap-20 '>
                ...
                <p>You can enable or disable your password for login. When password is empty, system will send you an automatic message with a login code. Otherwise, you can log in with your static password.</p>
                <div class="hr"></div>
                <p v-show='password_locked == 1' class='info strong p0 grid gap-20 md-col-2'>You are logging in with a password <button @click.prevent='removePassword()' class='cta red small justify-self-start'>Switch to login code</button></p>
